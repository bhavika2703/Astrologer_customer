...
String baseUrl = "https://bhavishydarpan.com/api";
String imgBaseurl = "https://bhavishydarpan.com/";
String webBaseUrl = "https://bhavishydarpan.com/api/";
String appMode = "LIVE";
Map<String, dynamic> appParameters = {
  "LIVE": {
    "apiUrl": "https://bhavishydarpan.com/api",
    "imageBaseurl": "https://bhavishydarpan.com/",
  },
  "DEV": {
    "apiUrl": "https://bhavishydarpan.com/api",
    "imageBaseurl": "https://bhavishydarpan.com/",
...
String agoraToken = "";
String channelName = "bhavishydarpan";
String agoraLiveToken = "";
String liveChannelName = "bhavishydarpan";
String agoraChatUserId = "bhavishydarpan";
String chatChannelName = "bhavishydarpan";
String agoraChatToken = "";
String encodedString = "&&";
Color coursorColor = Color(0xFF757575);
int? currentUserId;
String agoraResourceId = "55e80c5eb9f941feb64e62887f163d16";
String agoraResourceId2 = "";
String agoraSid1 = "7e7ad443b22b479f8a4666c8c62410ae";
String agoraSid2 = "";
String? googleAPIKey;
...
Future<void> callOnFcmApiSendPushNotifications({
  ...
  try {
    ...
    final url = Uri.parse(
        'https://fcm.googleapis.com/v1/projects/bhavishydarpan-cd2ba/messages:send');
